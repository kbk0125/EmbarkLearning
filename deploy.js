...
if (process.env.NODE_ENV === 'production') {
  ...
  child_process.exec("rimraf dist && cross-env NODE_ENV=production webpack --config ./webpack.production.config.js --progress --profile --colors", function (error, stdout, stderr) {
